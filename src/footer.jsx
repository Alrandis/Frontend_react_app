    ...
    return (
        ...
        <nav className="footer-menu">
            ...
            <ul className="footer-menu__list">
                ...
                <li className="footer-menu__item"><a data-goto="#title_list1" href="#"
                    className="menu__link">Достопримечательности</a></li>
        ...
        <div className="footer-contacts">
            ...
            <div className="footer-contacts__text">655019, Республика Хакасия, г. Абакан, пр. Ленина, д. 67</div>
            <div className="footer-contacts__text">Справочная служба: 8 (3902) 22-53-35, факс: 8 (3902) 24-30-71</div>
            <div className="footer-contacts__text">Электронная почта: kancler@vskhakasia.ru</div> 
        </div>
